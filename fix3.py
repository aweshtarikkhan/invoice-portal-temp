...
old_cell = '''                        <TableCell key={ds} className="text-center p-1 relative group">
                          <button
                            onClick={() => {
...
new_cell = '''                        <TableCell key={ds} className="text-center p-1 relative group">
                          {isHoliday || isOff ? (
...
if old_cell in code:
    ...
    print("Could not find old cell block")
