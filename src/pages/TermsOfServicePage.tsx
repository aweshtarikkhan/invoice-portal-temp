...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800">
      <SEO 
        title="Terms of Service | Aassay Biz" 
        description="Review the terms, conditions, and user agreements governing the use of Aassay Biz billing and business platform."
      />
      <PublicHeader />
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200/80 p-8 sm:p-12">
          ...
          <div className="space-y-8 text-sm leading-relaxed text-slate-600">
            <section>
              ...
              <p>
                By signing up, accessing, or using <AassayBizBrand /> ("Platform"), you agree to be bound by these Terms of Service. If you are using the platform on behalf of a company or registered legal entity, you represent that you have the authority to bind such entity to these Terms.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>You must immediately notify Aassay Biz of any unauthorized use or security breach of your account.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="mb-2">You agree NOT to use <AassayBizBrand /> for:</p>
            ...
            <section>
              ...
              <p>
                <AassayBizBrand /> offers free tiers and paid modular subscription plans (such as Sales & Inventory, Business Suite, Business HR, and CRM). Subscription fees are billed on a recurring monthly or annual basis as specified during checkout. Subscriptions renew automatically unless cancelled prior to the renewal date.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                All software, user interface designs, trademarks, brand logos, codebases, and platform documentation are the exclusive property of <AassayBizBrand />. You are granted a non-exclusive, non-transferable license to use the service for your internal business operations.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-3 p-4 bg-slate-100 rounded-xl space-y-1 text-slate-700">
                <p className="font-semibold text-slate-900 flex items-center gap-1.5"><AassayBizBrand /> Legal Department</p>
                <p>Email: <a href="mailto:support@aassaybiz.com" className="text-primary hover:underline">support@aassaybiz.com</a></p>
                <p>Phone: +91 7806025875</p>
              </div>
            </section>
          </div>
