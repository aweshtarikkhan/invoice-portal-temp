...
const dictionary: Record<string, string> = {
  // Sidebar
  "Dashboard": "डैशबोर्ड",
  "Business Accounting": "बिजनेस अकाउंटिंग",
  "Business HR": "बिजनेस एचआर",
  "Business CRM": "बिजनेस सीआरएम",
  "Business Promotion": "बिजनेस प्रमोशन",
  "Business Integration": "बिजनेस इंटीग्रेशन",
  "Business Feedback": "बिजनेस फीडबैक",
  "Business Analysis": "बिजनेस एनालिसिस",
  "Inventory Management": "इन्वेंटरी मैनेजमेंट",
  "Sales": "बिक्री (Sales)",
  "Invoices": "चालान (Invoices)",
  "Estimates": "अनुमान (Estimates)",
  "Quotations": "कोटेशन (Quotations)",
  "Clients": "ग्राहक (Clients)",
  "Client": "ग्राहक (Client)",
